...
public protocol PQNavigationItem where Self: UIViewController {
    ...
    func pq_pop(_ imageNamed: String, block:@escaping NavigationItemBlock)
    
    func pq_pop(_ image: UIImage?, block:@escaping NavigationItemBlock)
    
    func pq_addBarItem(_ imageNamed: String, derection: PQAddBarItemDirection, block: NavigationItemBlock?)
...
// MARK: 默认实现
public extension PQNavigationItem {
    ...
    func pq_pop(_ imageNamed: String, block:@escaping NavigationItemBlock) {
        pq_pop(imageNamed, size: .zero, block: block)
    }
    ...
    func pq_addBarItem(_ imageNamed: String, derection: PQAddBarItemDirection, block: NavigationItemBlock?) {
        pq_addBarItem(imageNamed, size: .zero, derection: derection, block: block)
    }
